...
const DEFAULT_PLATFORM_CAPABILITIES = Object.freeze({
  ...
  xiaohongshu: { search: true, detail: true, creator: true, chase: false, login: true, previewModes: ['search', 'creator'] },
  rednote: { search: true, detail: true, creator: true, chase: false, login: true, previewModes: ['search', 'creator'] },
...
class DownloadCrawlManager {
  ...
  async _preview(body = {}, observer = {}) {
    ...
    this._assertPreviewSupported(platform, mode);
