...
const WHISPER_MODELS_CONFIG = {
  base: {
    ...
    files: [
      { name: 'model.bin', size: 145 * 1024 * 1024 },
      { name: 'config.json', size: 2.36 * 1024 },
      { name: 'vocabulary.txt', size: 460 * 1024 },
      { name: 'tokenizer.json', size: 2.2 * 1024 * 1024 }
    ]
  },
  tiny: {
    repo: 'Systran/faster-whisper-tiny',
    files: [
      { name: 'model.bin', size: 75.5 * 1024 * 1024 },
      { name: 'config.json', size: 2.28 * 1024 },
      { name: 'vocabulary.txt', size: 460 * 1024 },
      { name: 'tokenizer.json', size: 2.2 * 1024 * 1024 }
    ]
  },
  small: {
    ...
    files: [
      { name: 'model.bin', size: 467 * 1024 * 1024 },
      { name: 'config.json', size: 2.36 * 1024 },
      { name: 'vocabulary.txt', size: 460 * 1024 },
      { name: 'tokenizer.json', size: 2.2 * 1024 * 1024 }
    ]
  ...
  medium: {
    ...
    files: [
      { name: 'model.bin', size: 1530 * 1024 * 1024 },
      { name: 'config.json', size: 2.36 * 1024 },
      { name: 'vocabulary.txt', size: 460 * 1024 },
      { name: 'tokenizer.json', size: 2.2 * 1024 * 1024 }
    ]
  ...
  'large-v3': {
    ...
    files: [
      { name: 'model.bin', size: 3000 * 1024 * 1024 },
      { name: 'config.json', size: 2.36 * 1024 },
      { name: 'vocabulary.json', size: 1070 * 1024 },
      { name: 'tokenizer.json', size: 2.2 * 1024 * 1024 },
...
async function ensureWhisperModelExist(modelsDir, modelName, progressCallback) {
  ...
  const whisperDir = path.join(modelsDir, 'whisper', modelName);
