...
module.exports = {
  ...
  // Client packaged không có .env, nên fallback production PHẢI trỏ đúng domain license thật.
  LICENSE_SERVER_URL: (required('LICENSE_SERVER_URL', 'https://editnhanh.com') || '').replace(/\/+$/, ''),
};
