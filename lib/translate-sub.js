...
const LANG_MAP = {
  ...
  ko: { name: 'Korean', nllb: 'kor_Hang', google: 'ko' },
  ja: { name: 'Japanese', nllb: 'jpn_Jpan', google: 'ja' },
  th: { name: 'Thai', nllb: 'tha_Thai', google: 'th' },
  fr: { name: 'French', nllb: 'fra_Latn', google: 'fr' },
  es: { name: 'Spanish', nllb: 'spa_Latn', google: 'es' },
  pt: { name: 'Portuguese', nllb: 'por_Latn', google: 'pt' },
  de: { name: 'German', nllb: 'deu_Latn', google: 'de' },
  it: { name: 'Italian', nllb: 'ita_Latn', google: 'it' },
  ru: { name: 'Russian', nllb: 'rus_Cyrl', google: 'ru' },
  id: { name: 'Indonesian', nllb: 'ind_Latn', google: 'id' },
  ms: { name: 'Malay', nllb: 'zsm_Latn', google: 'ms' },
  ar: { name: 'Arabic', nllb: 'arb_Arab', google: 'ar' },
  hi: { name: 'Hindi', nllb: 'hin_Deva', google: 'hi' },
  tr: { name: 'Turkish', nllb: 'tur_Latn', google: 'tr' }
};
...
async function translateSubtitles(inputPath, outputPath, geminiApiKey, maxLines = 0, maxCharsPerLine = 22, isCancelled = null) {
  ...
  const translationCheckpoint = createTranslationCheckpoint(outputPath, {
    ...
    pipeline: aiProvider === 'gemini-web'
      ? `gemini-web-viral-v2:${geminiWebMode}:${translationStyles.join('+') || 'auto'}`
      : 'shared-json-v3'
  });
