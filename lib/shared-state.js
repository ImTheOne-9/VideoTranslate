...
function getCookieStatus() {
  const platforms = ['bilibili', 'douyin', 'tiktok', 'youtube', 'facebook', 'instagram', 'xiaohongshu', 'youku'];
  const status = {};
...
function isValidVideoUrl(url) {
  ...
  return /^https?:\/\/(www\.|vt\.|vm\.|v\.|v\.)?(youtube\.com\/(shorts\/|watch\?v=)|youtu\.be\/|xiaohongshu\.com\/|xhslink\.com\/|facebook\.com\/|fb\.watch\/|fb\.com\/|tiktok\.com\/|douyin\.com\/|iesdouyin\.com\/|instagram\.com\/|instagr\.am\/|bilibili\.com\/|b23\.tv\/|youku\.com\/)/.test(cleanUrl);
}
