...
function getCrawlerPaths(options = {}) {
  ...
  return {
    ...
    userRoot,
    runtimeRoot,
    ocrRuntimeMarkerPath: path.join(runtimeRoot, 'ocr-runtime-v3.json'),
    resourceOcrRuntimeMarkerPath: path.join(resourceRuntimeRoot, 'ocr-runtime-v3.json'),
    voiceRuntimeMarkerPath: path.join(runtimeRoot, 'voice-runtime-v3.json'),
    resourceVoiceRuntimeMarkerPath: path.join(resourceRuntimeRoot, 'voice-runtime-v3.json'),
    piperRuntimeMarkerPath: path.join(runtimeRoot, 'piper-runtime-v1.json'),
    piperModelsDir: path.join(runtimeRoot, 'piper_models'),
    asrRuntimeMarkerPath: path.join(runtimeRoot, 'asr-runtime-v1.json'),
    resourceAsrRuntimeMarkerPath: path.join(resourceRuntimeRoot, 'asr-runtime-v1.json'),
    ocrGpuStatusPath: path.join(runtimeRoot, 'ocr-gpu-status.json'),
    whisperGpuStatusPath: path.join(runtimeRoot, 'whisper-gpu-status.json'),
    python,
    browserDataDir,
    dataDir,
