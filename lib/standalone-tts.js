...
// Trim only the real beginning/end of each generated line. A positive
// stop_periods value stops at the first matching silence, which can truncate
// normal speech at a comma or another short pause. Reversing the audio lets us
// reuse start-only trimming for the tail without touching pauses in the middle.
const BOUNDARY_SILENCE_FILTER = [
