...
app.get('/api/ocr-component/status', systemController.getOcrComponentStatus);
app.post('/api/ocr-component/download', systemController.startOcrComponentDownload);
app.get('/api/ocr-component/download-status', systemController.getOcrComponentDownloadStatus);
app.post('/api/ocr-component/cancel', systemController.cancelOcrComponentDownload);
